/******************************************************************************/
/***         Generated by IBExpert 2019.6.4.1 9/9/2019 10:41:19 PM          ***/
/******************************************************************************/
...
CREATE DOMAIN TEXTEND_DESCRIPTION AS
VARCHAR(8000);
...
CREATE GENERATOR GEN_APP$MODEL_ID;
SET GENERATOR GEN_APP$MODEL_ID TO 2;
...
CREATE TABLE APP$MODEL (
    ID_MODEL     TID NOT NULL,
    NAME         TSHORT_DESCRIPTION NOT NULL,
    HEADER_EDIT  TLONG_DESCRIPTION,
    SQL_INSERT   TDESCRIPTION,
    SQL_UPDATE   TDESCRIPTION,
    HEADER_VIEW  TEXTEND_DESCRIPTION NOT NULL,
    SQL_SELECT   TEXTEND_DESCRIPTION NOT NULL,
    SQL_DELETE   TSHORT_DESCRIPTION
);
...
ALTER TABLE APP$MODEL ADD CONSTRAINT PK_APP$MODEL PRIMARY KEY (ID_MODEL);
...
/* Trigger: APP$MODEL_BI */
CREATE TRIGGER APP$MODEL_BI FOR APP$MODEL
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.ID_MODEL is null) then
    new.ID_MODEL = gen_id(GEN_APP$MODEL_ID,1);
end
^
