...
public class ApplicationTest {
    ...
    private ResponseEntity<String> getModel(String item) {
        HttpHeaders httpHeaders = new HttpHeaders();
        HttpEntity<String> entity = new HttpEntity<>(null, httpHeaders);
        ResponseEntity<String> response = restTemplate.exchange(
                createURLWithPort("/api/model/person/" + item), HttpMethod.GET, entity, String.class);
        return response;
    }
    ...
    public void testGetModel() {
        ...
        ResponseEntity<String> response = getModel("get");
        String expected = "\"Валерий\",\"Ильин\",\"Геральдович\",\"\",\"\",\"\",\"2019-09-08\",\"\",\"\",\"\"," +
                "\"1955-06-12\",\"\"],[6,\"Василий\",\"Касмынин\",\"Павлович\",\"\",\"\",\"\",\"2019-09-08\"";
    ...
    public void testInsertModel() {
        ...
        ResponseEntity<String> newResponse = getModel("get");
